...
public class Esudiante{
    ...
    public Esudiante(String nombre, double promedio)
    {
        this.nombre=nombre;
    ...
    //recuperra el nombre del estudiante
    ...
    public void establecePromedio(double promedio)
    {
        //valida que el promedio sea > 0.0 y <=100.0; de lo contrario
        //mantiene el valor igual de la variable de instancia del promedio
        if(promedio > 0.0)
            if(promedio <=100.0)
                this.promedio = promedio; // asigna la variable de instancia
    }

    //recuperra el promedio
    public double obtenerPromedio()
    {
        return promedio;
    }

    //determina y devuelve la calificacion en letras del Estudiante
